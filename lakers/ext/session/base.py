...
from .hashcompact import md5_constructor
import random
...
class SessionBase(object):
    ...
    def _hash(self, value):
        key_salt = 'lakers' + self.__class__.__name__
    ...
    def _get_new_session_key(self):
        ...
        :return: new session key that isn't being used
        '''
        try:
            pid = os.getpid()
        except:  # if in jython, os has no func named getpid
            pid = 1
        while True:
    ...
    def set_session(self, session_data=None):
        """
        :param session_data:
        :return:
        """
    ...
    _session = property(get_session, set_session)
